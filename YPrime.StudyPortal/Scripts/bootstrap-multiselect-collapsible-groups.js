    ...
    jQuery.fn.multiselect.Constructor.prototype.buildDropdownOptions = (function() {
        ...
        return function() {
            ...
            if (this.options.enableCollapsibleOptGroups && this.options.multiple) {
                ...
                e("li.multiselect-group", this.$ul).siblings().not("li.multiselect-group, li.multiselect-all", this.$ul)
                    .each(function() {
                        $(this).toggleClass("hidden", true);
                    });
                e("li.multiselect-group", this.$ul).on("click",
                    e.proxy(function(t) {
                            t.stopPropagation();
                        },
                        this));
                e("li.multiselect-group > a > b", this.$ul).on("click",
                    e.proxy(function(t) {
                            t.stopPropagation();
                        ...
                        this));
                e("li.multiselect-group > a > input", this.$ul).on("change",
                    e.proxy(function(t) {
                            t.stopPropagation();
                            var n = e(t.target).closest("li");
                            var r = n.nextUntil("li.multiselect-group");
                        ...
                        this));
                e("li.multiselect-all", this.$ul).css("background", "#f3f3f3")
