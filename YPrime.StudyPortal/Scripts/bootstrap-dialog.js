/// THIS LIBRARY HAS BEEN MODIFIED, BECAUSE IT IS NO LONGER MAINTAINED
/// IF YOU'RE THINKING ABOUT UPGRADING THIS FILE, JUST REMOVE IT AND USE BOOTSTRAP AS INTENDED
...
(function(root, factory) {
    ...
    BootstrapDialog.prototype = {
        ...
        createFooterButtons: function() {
            var that = this;
            var $container = $('<div></div>');
            $container.addClass(this.getNamespace('footer-buttons') + this.options.groupButtons ? ' btn-group' : '');
            this.indexedButtons = {};
            $.each(this.options.buttons, function(index, button) {
                if (!button.id) {
