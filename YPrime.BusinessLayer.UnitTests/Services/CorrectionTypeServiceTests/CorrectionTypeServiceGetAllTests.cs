...
{
    [TestClass]
    public class CorrectionTypeServiceGetAllTests : CorrectionTypeServiceTestBase
    {
        [TestMethod]
        public async Task GetAllTest()
        {
            var expectedResult = JsonConvert.DeserializeObject<List<CorrectionTypeModel>>(GetAllResponse);
