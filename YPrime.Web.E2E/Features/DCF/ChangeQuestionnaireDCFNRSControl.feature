Feature: Change Questionnaire DCF NRS Control
...
#NRS - MIn 0 Max 10
#1
Scenario: Verify that NRS control is a dropdown with the configured min-max value in Change Questionnaire Responses DCF and also verify that "Please provide a response" place holder text is displayed. 
    ...
    And the following data is displayed in the existing question correction fields
        ...
        | Please indicate the pain level from the scale of 0-10.                              | 4             | Please provide a response | NumberSpinner |
...
Scenario: Data is persisted when user click next and back button on data correction page.   
    ...
    Then the following data is displayed in the existing question correction fields
        | Label                                                                               | Current Value | Requested Value | Fieldtype     |
        | Please indicate the pain level from the scale of 0-10.                              | 4             | 7               | NumberSpinner |
